...
// Read-only: a school_admin may view their school's students, but creating,
// editing, or deleting an account is super_admin-only, via /api/admin/system/students.
